...
const departments = [
  {
    ...
    img: '/departamento-ingenieria.jpeg',
  },
  {
  ...
  },
  {
    ...
    img: '/departamento-administrativo.jpeg',
  },
]

const slides = departments.map(d => ({ img: d.img, alt: d.name }))
</script>
...
<template>
  ...
  <!-- Department carousel -->
  <ContentCarousel :slides="slides" class="mb-24">
